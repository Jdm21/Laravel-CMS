                ...
                <div class="card-body">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td class="align-middle">{{ str()->limit($item->title,45,'...') }}</td>
                            ...
                            <td class="align-middle">
                                ...
                                <button onclick="if (confirm('Você deseja realmente excluir essa notícia?')) { this.form.submit() }" type="button" class="btn btn-sm btn-danger">Excluir</button>
                               @endcan 
